  ...
  <form onSubmit={handleSubmit}>
    <div className="mb-6">
      ...
      <input
        ...
        className="w-full px-4 py-2 border rounded-lg shadow-sm bg-gray-50 border-gray-300 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
    ...
    <div className="mb-6">
      ...
      <select
        ...
        onChange={handleChange}
        className="w-full px-4 py-2 border rounded-lg shadow-sm bg-gray-50 border-gray-300 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        required
      >
